...
from .import_utils import is_torch_fx_proxy
...
GPTJ_PRETRAINED_MODEL_ARCHIVE_MAP = {"gptj": "https://huggingface.co/EleutherAI/gpt-j-6b/resolve/main/pytorch_model.bin",
                                     "EleutherAI/gpt-j-6B": "https://huggingface.co/EleutherAI/gpt-j-6b/resolve/main/pytorch_model.bin"}
...
class GPTJAttention(nn.Module):
    ...
    def forward(
        ...
        if layer_past is not None:
            ...
            past_key = self._split_heads(past_key, self.num_attention_heads, self.head_dim, False)
            past_value = self._split_heads(past_value, self.num_attention_heads, self.head_dim, False)
...
class GPTJPreTrainedModel(PreTrainedModel):
    ...
    pretrained_model_archive_map = GPTJ_PRETRAINED_MODEL_ARCHIVE_MAP
...
class GPTJModel(GPTJPreTrainedModel):
    ...
    def forward(
        ...
        latent_as_gpt_emb: Optional[bool] = False,
        latent_as_gpt_memory: Optional[bool] = True
        ...
        if past_key_values is None:
            ...
            if latent_as_gpt_memory:
                ...
                if share_latent: 
                    ...
                    past_key_value = [past_key_values.unsqueeze(-2), past_key_values.unsqueeze(-2)] # query, key
                    past_key_values = [past_key_values] * len(self.h)
                    ...
                    past_key_values = tuple(zip(past_split,past_split))
...
class GPTJForLatentConnector(GPTJPreTrainedModel):
